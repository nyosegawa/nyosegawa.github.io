---
title: "日本語の手書きメモを書き起こせるOCRを探すために22モデルを片っ端から試した話"
description: "手書きメモの電子化がつらいので、Claude, Gemini, GPTからHunyuanOCR, Sarashina2.2-OCRまで22モデルを3指標で比較しました。結論: Gemini 3.1 Proが最強です"
date: 2026-03-17
...
今日は日本語の手書きメモをいい感じに書き起こしてくれるOCRを探して、22モデルを片っ端から比較してみた話をまとめていきたいと思います。
...
APIで呼べるモデル10個と、GPU上で動かすOSSモデル12個を比較しました。
...
| 19 | PaddleOCR | Modal | 0.353 | 0.394 | 0.784 | 12.8s |
| 20 | NDLOCR-Lite | Modal | 0.271 | 0.394 | 0.915 | 10.5s |
| 21 | GOT-OCR 2.0 | Modal | 0.194 | 0.250 | 0.888 | 10.2s |
| 22 | NDLOCR v2 | Modal | 0.064 | 0.087 | 0.958 | 28.7s |
...
- 日本語手書きメモのOCRに使えるモデルを探して22モデルを比較しました
