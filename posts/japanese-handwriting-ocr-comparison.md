---
title: "日本語の手書きメモを書き起こせるOCRを探すために21モデルを片っ端から試した話"
description: "手書きメモの電子化がつらいので、Claude, Gemini, GPTからHunyuanOCR, GLM-OCRまで21モデルを3指標で比較しました。結論: Gemini 3.1 Proが最強です"
date: 2026-03-17
...
今日は日本語の手書きメモをいい感じに書き起こしてくれるOCRを探して、21モデルを片っ端から比較してみた話をまとめていきたいと思います。
...
APIで呼べるモデル10個と、GPU上で動かすOSSモデル11個を比較しました。
...
- 日本語手書きメモのOCRに使えるモデルを探して20モデルを比較しました
