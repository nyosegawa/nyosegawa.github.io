...
今日は[前回の記事](https://nyosegawa.com/posts/skill-creator-and-orchestration-skill/)で「未解決の問題」として残しておいた、スキル間のAttention競合問題に正面から取り組んだ話をしていきます。作ったスキルが10個、20個と増えてきたとき、それぞれがちゃんと正しく発火しているのか。あるスキルのdescriptionを改善したら別のスキルの精度が下がっていないか。そんなポートフォリオレベルの監査を自動でやってくれるスキル、[skill-auditor](https://github.com/nyosegawa/skills/blob/main/skills/skill-auditor/SKILL.md)を作りました（現在はClaude Code専用となっています）。
...
skill-creatorの詳しい解説は[前回の記事](https://nyosegawa.com/posts/skill-creator-and-orchestration-skill/)をご覧ください。
...
### 関連記事
- [skill-creatorから学ぶSkill設計と、Orchestration Skillの作り方](https://nyosegawa.com/posts/skill-creator-and-orchestration-skill/) — 前回記事
